...
CORS(app, supports_credentials=True, resources={r"/*": {"origins": ["https://atimosai.com", "http://localhost:5500"]}})
...
def generate():
    ...
    try:
        ...
        print("Groq error:", e)
        return jsonify({"error": "AI temporarily unavailable. Try again."}), 502
...
def google_callback():
    ...
    try:
        ...
        print(f"Redirecting to frontend with token: {session_token}")
        return redirect(f"https://atimosai.com/?token={session_token}")
